...
def Main():
    ...
    if playerCards != 0:
        ...
        print(sameColorPlayerCardsToThrowAway)
        ...
        print(sameNumberPlayerCardsToThrowAway)
        ...
        print(allowedPlayerCardsToThrowAway)
