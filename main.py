...
## MIDDLE PART
        ...
        middleLayout.setColumnStretch(1, 189)
        middleLayout.setColumnStretch(2, 1178)
        middleLayout.setColumnStretch(3, 189)

        ##BOT 2 NAME
        bot2 = QWidget(middlePart)
        bot2.setStyleSheet(".QWidget {border-image: none}")
        middleLayout.addWidget(bot2, 0, 0)
        bot2NameLayout = QGridLayout(bot2)
        bot2NameLayout.setContentsMargins(25, 70, 25, 35)

        bot2Image = QWidget(middlePart)
        ...
        ##BOT 2 CARDS
        bot2Cards = QWidget(middlePart)
        bot2Cards.setStyleSheet(".QWidget {border-image: none}")
        middleLayout.addWidget(bot2Cards, 0, 1)
        bot2Layout = QGridLayout(bot2Cards)
        bot2Layout.setContentsMargins(0, 0, 0, 0)

        bot2Card1 = QWidget(middlePart)
        bot2Card1.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot2Layout.addWidget(bot2Card1, 0, 0)
        bot2Card2 = QWidget(middlePart)
        bot2Card2.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot2Layout.addWidget(bot2Card2, 1, 0)
        bot2Card3 = QWidget(middlePart)
        bot2Card3.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot2Layout.addWidget(bot2Card3, 2, 0)
        bot2Card4 = QWidget(middlePart)
        bot2Card4.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot2Layout.addWidget(bot2Card4, 3, 0)
        bot2Card5 = QWidget(middlePart)
        bot2Card5.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot2Layout.addWidget(bot2Card5, 4, 0)
        ##

        ##MIDDLE PART
        middle = QWidget(middlePart)
        middle.setStyleSheet(".QWidget {border-image: none}")
        middleLayout.addWidget(middle, 0, 2)
        middleGrid = QGridLayout(middle)
        middleGrid.setContentsMargins(0, 0, 0, 0)
        middleGrid.setColumnStretch(0, 341)
        middleGrid.setColumnStretch(2, 147)
        middleGrid.setColumnStretch(4, 341)

        stackImage = QPushButton(middlePart)
        stackImage.setFixedSize(171, 249)
        stackImage.setStyleSheet("border-image: url(./images/cardBackV.png)")
        stackImage.setCursor(Qt.PointingHandCursor)
        stackImage.clicked.connect(self.menu)
        middleGrid.addWidget(stackImage, 0, 1)

        throwStackImage = QPushButton(middlePart)
        throwStackImage.setFixedSize(171, 249)
        throwStackImage.setStyleSheet("border-image: url(./images/cardBackV.png)")
        throwStackImage.setCursor(Qt.PointingHandCursor)
        throwStackImage.clicked.connect(self.menu)
        middleGrid.addWidget(throwStackImage, 0, 3)
        ##

        ##BOT 3 CARDS
        bot3Cards = QWidget(middlePart)
        bot3Cards.setStyleSheet(".QWidget {border-image: none}")
        middleLayout.addWidget(bot3Cards, 0, 3)
        bot3Layout = QGridLayout(bot3Cards)
        bot3Layout.setContentsMargins(0, 0, 0, 0)

        bot3Card1 = QWidget(middlePart)
        bot3Card1.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot3Layout.addWidget(bot3Card1, 0, 0)
        bot3Card2 = QWidget(middlePart)
        bot3Card2.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot3Layout.addWidget(bot3Card2, 1, 0)
        bot3Card3 = QWidget(middlePart)
        bot3Card3.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot3Layout.addWidget(bot3Card3, 2, 0)
        bot3Card4 = QWidget(middlePart)
        bot3Card4.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot3Layout.addWidget(bot3Card4, 3, 0)
        bot3Card5 = QWidget(middlePart)
        bot3Card5.setStyleSheet("border-image: url(./images/cardBack.png)")
        bot3Layout.addWidget(bot3Card5, 4, 0)
        ##

        ##BOT 3 NAME
        bot3 = QWidget(middlePart)
        bot3.setStyleSheet(".QWidget {border-image: none}")
        middleLayout.addWidget(bot3, 0, 4)
        bot3NameLayout = QGridLayout(bot3)
        bot3NameLayout.setContentsMargins(25, 70, 25, 35)

        bot3Image = QWidget(middlePart)
